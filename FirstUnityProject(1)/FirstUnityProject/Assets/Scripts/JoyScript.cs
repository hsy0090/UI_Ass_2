...
public class JoyScript : MonoBehaviour {
    ...
    public void Dragging()
    {
        ...
        Vector3 temp = new Vector3(Input.mousePosition.x - startPosition.x, Input.mousePosition.y - startPosition.y, 1);
        float radius = 50;
        Vector2 clampPos = Vector2.ClampMagnitude(new Vector2(temp.x, temp.y), radius);
